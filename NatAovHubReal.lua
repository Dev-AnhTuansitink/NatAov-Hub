-- // [[ Nat Aov Hub Main Blox Fruits V2 ]] \\
...
task.spawn(function()
    pcall(function()
       loadstring(game:HttpGet'https://pastefy.app/VQ7gO7WM/raw')()
    end)
end)
...
task.spawn(function()
    pcall(function()
        loadstring(game:HttpGet'https://pastefy.app/vpxWXrmP/raw')()
    end)
end)
...
task.spawn(function()
    pcall(function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/Dev-AnhTuansitink/NatAov-Hub/refs/heads/main/EzFastAttack.lua"))()
    end)
end)
...
NotificacaoTuanDz("NatAov Hub", "Script đang tải vui lòng chờ!!")
...
elseif placeId == 7449423635 or placeId == 100117331123089 then
    ...
    plr:Kick("❌ Script chỉ hỗ trợ game blox fruits!")
end
...
BringEnemy = function()
    ...
    for _, it in ipairs(list) do
        ...
        if speed <= 0 then
            ...
            local dist = (pp.Position - PosMon).Magnitude
            local t = math.clamp(dist / speed,0.05,0.5)
...
QuestNeta = function()
	...
	local Library = loadstring(game:HttpGet("https://pastefy.app/2ygvEBjS/raw"))():MakeWindow({
    Title = "NatAov Hub OLD",
    SubTitle = "By Dev-AnhTuansitink",
...
Discord:AddDiscordInvite({
    Name = "NatAov Hub Community",
    Description = "Vào sever để lấy client và script free!",
    Logo = "rbxassetid://120488231660846",
    Invite = "https://discord.gg/h3jnnm7W"
})
local credits = Discord:AddParagraph({
    Title = "Phiên Bản Cũ",
    Desc = ""
})
credits:SetDesc("NguyenAnhTuan ( Admin của hub )")

local scripts = Discord:AddParagraph({
    Title = "Thông tin cập nhật:",
    Desc = ""
})
scripts:SetDesc("Ae Vô Discord Tui Để Lấy Script Bản Mới Nhé !!")
...
Shop:AddSection("Kĩ Năng")
Shop:AddButton({
    Name = "Nhảy Trên Không [ $10,000 Beli ]",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki", "Geppo")
    end
})
Shop:AddButton({
    Name = "Haki Vũ Trang [ $25,000 Beli ]",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki", "Buso")
    end
})
Shop:AddButton({
    Name = "Haki Quan Sát [ $750,000 Beli ]",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("KenTalk", "Buy")
    end
})
Shop:AddButton({
    Name = "Tốc Biến [ $100,000 Beli ]",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki", "Soru")
    end
})
Shop:AddSection("Khác")
Shop:AddButton({
    Name = "Đặt Lại Chỉ Số (2500F)",
    Callback = function()
        local Remote = game:GetService("ReplicatedStorage").Remotes.CommF_
...
spawn(function()
    while wait() do
        pcall(function()
            ...
            if len == 88 then
                MobCakePrince:SetDesc("Còn : " .. string.sub(response, 39, 41))
            elseif len == 87 then
                MobCakePrince:SetDesc("Còn : " .. string.sub(response, 39, 40))
            elseif len == 86 then
                MobCakePrince:SetDesc("Còn : " .. string.sub(response, 39, 39) .. " ")
            else
                MobCakePrince:SetDesc("✅️")
            end
        end)
    end
end)
local TyrantStatus = Status:AddParagraph({
    Title = "Boss Tyrant Of The Skies",
    Desc = "Trạng thái: "
})
spawn(function()
    pcall(function()
    ...
    while wait() do
        pcall(function()
            ...
            or ws:FindFirstChild("Diablo") or ws:FindFirstChild("Deandre") or ws:FindFirstChild("Urban") then
                EliteHunter:SetDesc(" ✅️ | Đã Giết: " .. progress)
            else
                EliteHunter:SetDesc(" ❌️ | Đã Giết: " .. progress)
            end
        end)
    ...
    pcall(function()
        while wait() do
            ...
            elseif rs:InvokeServer("LegendarySwordDealer", "3") then
                ...
                LegendarySword:SetDesc("không có")
            end
        end
    end)
end)
...
spawn(function()
    pcall(function()
        while wait() do
            ...
            Bone:SetDesc("Bạn đang có : " .. tostring(bones) .. " Xương")
        end
    end)
end)
Status:AddTextBox({
...
Status:AddButton({
    Name = "Chuyển máy chủ hop",
    Callback = function()
        Hop()
    end
})
Status:AddButton({
    Name = "Chuyểm máy chủ ít người",
    Callback = function()
...
Farm:AddSection({"Auto Farm Chính"})
Farm:AddDropdown({
    Name = "Chọn vũ khí",
    Description = "",
...
-- AUTO SOUL REAPER
Farm:AddToggle({
    Name = "Auto boss tử thần ( soul reaper )",
    Default = false,
    Callback = function(v)
        _G.AutoHytHallow = v
    end,
...
if World3 then
Farm:AddSection({"Mini Yoru +  Mũ Valkyrie"})
Farm:AddToggle({
    Name = "Tự động giết Rip Indra",
    Description = "",
...
Setting:AddButton({
    Name = "Lưu config ",
    Description = "Lưu cài đặt mà bạn đang dùng",
    Callback = function()
...
Setting:AddToggle({
	Name = "Bay lên nếu máu yếu",
	Description = "bật lên để bảo vệ bạn nếu máu ở mức thấp",
	-- 1. Carrega o estado salvo
...
Setting:AddSection({"Tùy Chỉnh"})
Setting:AddTextBox({
    Title = "khoảng cách gôm quái",
    Description = "",
    PlaceHolder = "235",
...
Others:AddSection({"Câu cá vạn cân:))"})
-- =========================================================
            ...
            pcall(function()
                ...
                if _G.SelectedRod and (not equippedTool or equippedTool.Name ~= _G.SelectedRod) then
                    ...
                    if rodInBag then
                        ...
                        NotificacaoTuandz2("Làm ơn trang bị:" .. tostring(_G.SelectedRod))
...
Others:AddToggle({
    ...
    Description = "Nhận nhiệm vụ từ NPC Angler.",
    -- Carrega se estava ligado
...
-- 8. AUTO SPAM SKILL Z
Others:AddToggle({
    Name = "Tự động sử dụng skill z của cần câu",
    Description = "spam skil z của cần câu",
    -- Carrega se estava ligado
...
Others:AddButton({
    ...
    Callback = function()
        ...
        if FoundAny then 
            ...
            BossDropdown:Refresh({"Không tìm thấy boss"}, true) 
        end  
    end
})

Others:AddToggle({
    Name = "Auto Farm Boss Đã Chọn",
    Default = false,
    Callback = function(v)
        _G.AutoBoss = v
...
Others:AddSection({"Nhiệm vụ"})
 Others:AddToggle({
    Name = "Auto Farm Điểm Haki quan sát",
    Description = "",
    -- 1. Carrega o estado salvo ou false por padrão
...
Others:AddToggle({
	Name = "Nhiệm vụ công dân tự động",
	Description = "",
	Default = false,
	Callback = function(I)
		_G.CitizenQuest = I;
...
Others:AddSection({"Kiếm bị nguyền rủa"});
local r = Others:AddParagraph({ Title = "Elites trạng thái: ", Content = "" });
spawn(function()
	while wait(Sec) do
		pcall(function()
			r:SetDesc("Elite đã giết :  " .. replicated.Remotes.CommF_:InvokeServer("EliteHunter", "Progress"));
		end);
	end;
end);
Others:AddToggle({
	Name = "Auto Giết Elite",
	Description = "",
	-- 1. Carrega o estado salvo ou false por padrão
...
spawn(function()
 ...
 Others:AddToggle({
    Name = "Dừng khi có vật phẩm hiếm",
    Description = "",
...
Others:AddSection({"Màu sắc haki / Hoà quang"});

 Others:AddToggle({
    Name = "Dịch chuyển tới Barista Haki",
    Description = "",
    -- 1. Carrega se estava ligado ou desligado ao abrir o script
...
spawn(function()
 ...
 Others:AddToggle({
    Name = "Nhận nhiệm vụ bypass [Risk]",
    Description = "",
...
local z5 = {
    ...
    if World3 then
        ...
        Event:AddDropdown({
            Name = "Chọn level biển",
            Description = "Chọn mức độ nguy hiểm ",
            Options = H5,
            Default = "Lv 1",
            Multi = false,
            Callback = function(I)
    ...
    Event:AddToggle({
        Name = "Auto bắt đầu sea event",
        Description = "tự mua thuyền và đi ra biển",
        Default = false,
        Callback = function(I)
            _G.SailBoats = I;
        end,
...
Event:AddToggle({
        Name = "Kích hoạt tốc độ thuyền",
        Description = "tùy chỉnh tốc độ thuyền",
        Default = false,
        Callback = function(Value)
            _G.SpeedBoat = Value
        end
...
Event:AddSection({"Auto đánh sea event"})
    Event:AddToggle({
        Name = "Tấn công Sea Beast",
        Description = "",
        Default = false,
        Callback = function(I)
            _G.SeaBeast1 = I;
...
Event:AddToggle({
    Name = "Tấn công Pirate GrandBrigade",
    Description = "",
    Default = false,
    Callback = function(I)
        _G.PGB = I;
...
if World2 then
  Event:AddSection({"Go to Sea 3 pls "})
end
if World1 then
  Event:AddSection({"Go to Sea 3 or Sea 2 Bro!"})
end
...
Event:AddToggle({
    Name = "Tấn công Fish Crew Member",
    Description = "",
    Default = false,
    Callback = function(I)
        _G.MobCrew = I;
...
Event:AddToggle({
    Name = "Tấn công Haunted Crew Member",
    Description = "",
    Default = false,
    Callback = function(I)
        _G.HCM = I;
...
Event:AddButton({
	Name = "Mua chuộc gián điệp",
	Description = "Mua spy để tìm levi",
	Callback = function()
...
Event:AddSection({"Đảo kitsune"});
Event:AddToggle({
    Name = "Auto tìm đảo cáo",
    Description = "",
...
Event:AddToggle({
    Name = "Auto Trao đổi Azure Ember",
    Description = "",
...
Event:AddButton({ Name = "Trao đổi đồ đảo cáo", Description = "", Callback = function()
		(replicated.Modules.Net:FindFirstChild("RF/KitsuneStatuePray")):InvokeServer();
	end });
Event:AddButton({ Name = "Trò chuyện với tượng cáo", Description = "", Callback = function()
		(replicated.Modules.Net:FindFirstChild("RE/TouchKitsuneStatue")):FireServer();
	end });
	Event:AddSection({"Đảo kì bí "});
Event:AddToggle({
	Name = "Auto tìm đảo kì bí",
    Description = "",
    -- 1. Carrega se estava ligado ou desligado
    Default = GetSetting("FindMirage_Save", false),
    Callback = function(I)
        _G.FindMirage = I
  --Tao đã dịch đến đây ok dịch tiếp đi     
        -- 2. Guarda na tabela de salvamento
...
Event:AddToggle({
	Name = "Tự động bay đến điểm cao nhất",
    Description = "Bay đến điểm cao nhất của Mirage (Lý tưởng để ngắm trăng)",
    -- 1. Carrega o estado salvo
...
Event:AddToggle({
	Name = "Auto Nhặt bánh răng",
    Description = "Nhặt gear blue",
...
Event:AddToggle({
	Name = "Bay Đến Advanced Fruit Dealer",
    Description = "Bay đến gian hàng trái cây cao cấp trên Mirage.",
    -- 1. Carrega se o teleporte estava ativo
...
Event:AddToggle({
	Name = "Auto nhặt rương ở đảo kì bí",
	Description = "",
	Default = false,
	Callback = function(I)
		_G.FarmChestM = I;
...
spawn(function()
	...
	Event:AddSection({"Nam châm núi lửa"});
-- Configurações de UI e Toggle
Event:AddToggle({
    Name = "Auto Chế Tạo Nam Châm Núi Lửa",
    Description = "Bật chế độ tự động thu thập nguyên liệu và chế tạo nam châm núi lửa, và dừng lại khi bạn đã có 1 nam châm núi lửa.",
    Default = false,
    Callback = function(I)
        _G.CraftVM = I;
    end,
...
Event:AddSection({"Đảo núi lửa"});
Event:AddToggle({
    Name = "Auto Tìm Đảo núi lửa",
    Description = "",
...
-- 3. TOGGLE: Auto Reset
Event:AddToggle({
    Name = "Auto Reset Khi Hoàn Thành",
    Description = "",
...
if World2 or World3 then
Event:AddSection({"Cài Đặt Skill - Võ"})
-- [[ TOGGLES MELEE ]]
Event:AddToggle({
    Name = "Skill Z",
...
Event:AddSection({"Skill Trái Blox"})
...
Maestry:AddToggle({
    Name = "Auto Cày Thông Thạo Trái Blox",
    Description = "",
...
if World2 then
Race:AddSection({"Nâng Cấp Tộc"});
Race:AddToggle({
    Name = "Auto Nâng Tộc Thỏ v2/3",
    Description = "",
    Default = false,
    Callback = function(I)
        G.Auto_Mink = I;
...
Race:AddToggle({
    Name = "Auto Nâng Tộc Người V2/V3",
    Description = "",
    Default = false,
    Callback = function(I)
        G.Auto_Human = I;
...
Race:AddToggle({
    Name = "Auto Nâng Tộc Thiên Thần V2/V3",
    Description = "",
    Default = false,
    Callback = function(I)
        G.Auto_Skypiea = I;
...
Race:AddSection({"Nâng cấp Tộc v4 ở sea 3"});
end
if World1 then
Race:AddSection({"Chỉ sea 2 hoặc sea 3 để up tộc"});
end
if World3 then
Race:AddSection({"Thử Thách / Tộc v4"});
local K5 = Race:AddParagraph({ Title = " Trạng thái v4 ", Content = "" });
spawn(function()
	pcall(function()
		while wait(.2) do
			K5:SetDesc(" Gears  :" .. (" " .. plr.Data.Race.C.Value));
		end;
	end);
end);
Race:AddToggle({
	Name = "Auto Nhìn Trăng",
	Description = "",
	Default = false,
	Callback = function(I)
		LookM = I;
...
Race:AddButton({ Name = "Dịch chuyển tức thời đến Đền Thời Gian", Description = "", Callback = function()
		replicated.Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(28286.35546875, 14895.301757812, 102.62469482422));
	end });
Race:AddButton({ Name = "Dịch chuyển tức thời đến Ancient One", Description = "", Callback = function()
		notween(CFrame.new(28981.552734375, 14888.426757812, -120.24584960938));
	end });
Race:AddButton({ Name = "Dịch chuyển tức thời đến Đồng hồ cổ", Description = "", Callback = function()
		notween(CFrame.new(29549, 15069, -88));
	end });
Race:AddToggle({
	Name = "Tự động dịch chuyển đến cửa up v4",
	Description = "",
	Default = false,
	Callback = function(I)
		_G.TPDoor = I;
...
Race:AddToggle({
	Name = "Auto hoàn thành trial up v4",
	Description = "",
	Default = false,
	Callback = function(I)
...
Race:AddToggle({
	Name = "Tự động tiêu diệt người chơi sau khi trial",
	Description = "bật chế độ tiêu diệt người chơi sau cuộc đua thử nghiệm",
	Default = false,
	Callback = function(I)
		_G.Defeating = I;
	end,
...
if World3 then
Dojo:AddSection({"Nhiệm Vụ DoJo & Tộc Draco"});
Dojo:AddToggle({
	Name = "Auto làm nhiệm vụ Dojo Trainer",
	Description = "bật chế độ làm đai từ trắng đến đai đen",
	Default = false,
	Callback = function(I)
		_G.Dojoo = I;
	end,
...
Dojo:AddToggle({
	Name = "Auto làm nhiệm vụ Dragon Hunter",
	Description = "Bật để farm blaze ember + auto thu thập blaze ember",
	Default = false,
	Callback = function(I)
		_G.FarmBlazeEM = I;
	end,
...
Dojo:AddToggle({
	Name = "Bay đến nâng cấp Draco Trial",
	Description = "",
	Default = false,
	Callback = function(I)
		_G.UPGDrago = I;
...
Dojo:AddToggle({
	Name = "Auto up tộc draco (V1)",
	Description = "bật chế độ tự động nhiệm vụ 1, sự kiện thời tiền sử tự động + thu thập trứng rồng",
	Default = false,
	Callback = function(I)
		_G.DragoV1 = I;
	end,
...
Dojo:AddToggle({
	Name = "Auto up tộc draco (V2)",
	Description = "Bật chế độ tự động tiêu diệt Cướp rừng và Thu thập hoa lửa",
	Default = false,
	Callback = function(I)
...
Dojo:AddToggle({
	Name = "Tự động Relic Draco Trial [ Beta ]",
	Description = "Bật chế độ dùng thử tự động v4, bạn phải tự mình làm",
	Default = false,
	Callback = function(I)
		_G.Relic123 = I;
	end,
...
Dojo:AddToggle({
	Name = "Tự động huấn luyện train Draco",
	Description = "Bật chế độ huấn luyện Drago Race v4 + tự động nâng cấp cấp độ",
	Default = false,
	Callback = function(I)
		_G.TrainDrago = I;
	end,
...
Dojo:AddToggle({
	Name = "Nâng cấp Dragon Talon với Uzoth",
	Description = "",
	Default = false,
	Callback = function(I)
		_G.DT_Uzoth = I;
...
Esp:AddToggle({Name = "Esp Quả Berry", Default = false, Callback = function(I) 
    BerryEsp = I; 
    spawn(function() while BerryEsp do wait(1); berriesEsp(); end; end); 
end});

Esp:AddToggle({Name = "Esp Người Chơi", Default = false, Callback = function(I) 
    PlayerEsp = I; 
    spawn(function() while PlayerEsp do wait(0.1); EspPly(); end; end); 
end});

Esp:AddToggle({Name = "Esp Rương", Default = false, Callback = function(I) 
    ChestESP = I; 
    spawn(function() while ChestESP do wait(1); ChestEsp(); end; end); 
end});

Esp:AddToggle({Name = "Esp Trái", Default = false, Callback = function(I)
    DevilFruitESP = I
    task.spawn(function() while DevilFruitESP do task.wait(1); pcall(DevEsp) end end)
end})

Esp:AddToggle({Name = "Esp Đảo", Default = false, Callback = function(I)
    _G.IslandESP = I;
    task.spawn(function() while _G.IslandESP do IslandESP_Func(); task.wait(2) end; IslandESP_Func() end)
end});

if World2 then
    Esp:AddToggle({Name = "Esp Hoa", Default = false, Callback = function(I)
        FlowerESP = I
        task.spawn(function() while FlowerESP do pcall(flowerEsp); task.wait(1) end end)
    end})
    Esp:AddToggle({Name = "Esp Kiếm Huyền Thoại", Default = false, Callback = function(I)
        LegenS = I
...
if World2 or World3 then
    Esp:AddToggle({Name = "Esp Người bán haki màu", Default = false, Callback = function(I)
        ColorEsp = I
...
if World3 then
    Esp:AddToggle({Name = "Esp Bánh Răng", Default = false, Callback = function(I)
        ESPGear = I
        task.spawn(function() while ESPGear do pcall(gearEsp); task.wait(1) end end)
    end})
    Esp:AddToggle({Name = "Esp Người bán trái cao cấp", Default = false, Callback = function(I)
        advanEsp = I
...
Player:AddTextBox({
    Name = "Tốc độ",
    Description = "Nhập tốc độ bạn muốn",
    PlaceHolder = "16",
...
Player:AddTextBox({
    Name = "Độ cao",
    Description = "Nhập độ cao khi nhảy",
    PlaceHolder = "50",
...
Player:AddSection({"Cài đặt LocalPlayer / Khác"});
Player:AddToggle({
	Name = "Tộc thỏ v3 vô hạn",
	Description = "",
	Default = false,
	Callback = function(I)
		InfAblities = I;
...
Player:AddSection({"Cài đặt Chiến đấu / Cài đặt Aimbot"});
Player:AddToggle({
	Name = "Bỏ qua cùng team",
	Description = "bật chế độ bỏ qua khôngi aimbot cùng đội",
	Default = false,
	Callback = function(I)
		_G.NoAimTeam = I;
	end,
...
Teleport:AddSection({"Dịch chuyển - Thế giới"});
Teleport:AddButton({ Name = "Dịch chuyển đến Sea 1", Description = "", Callback = function()
		replicated.Remotes.CommF_:InvokeServer("TravelMain");
	end });
Teleport:AddButton({ Name = "Dịch chuyển đến sea 2", Description = "", Callback = function()
		replicated.Remotes.CommF_:InvokeServer("TravelDressrosa");
	end });
Teleport:AddButton({ Name = "Dịch chuyển đến Sea 3", Description = "", Callback = function()
		replicated.Remotes.CommF_:InvokeServer("TravelZou");
	end });
Teleport:AddSection({"Dịch chuyển - Đảo"})
...
Teleport:AddSection({"Dịch chuyển - Cổng"});
if World1 then
...
Teleport:AddButton({ Name = "Dịch Chuyển Tức Thời", Description = "", Callback = function()
...
Teleport:AddSection("Dịch chuyển - Npc");
...
Teleport:AddToggle({
	Name = "Bay đến  NPCs",
	Description = "Tự động dịch chuyển đến NPC",
	Default = false,
	Callback = function(I)
		_G.TPNpc = I;
	end,
...
if World3 then
Get:AddSection({"Súng Skull Guitar"});
Get:AddToggle({
	Name = "Auto súng Skull Guitar",
	Description = "",
	Default = false,
	Callback = function(I)
...
if World2 or World3 then
Get:AddToggle({
	Name = "Auto cày nguyên liệu súng Skull Guitar",
	Description = "",
	Default = false,
	Callback = function(I)
		_G.AutoMatSoul = I;
...
Get:AddSection({"Farm thông thạo"});
...
Get:AddToggle({
	Name = "Auto cày 600 thông thạo ở kiếm",
	Description = "",
	Default = false,
	Callback = function(I)
		_G.FarmMastery_S = I
...
if World3 then
Get:AddSection({"Song kiếm bị nguyền rủa"});
local I5 = Get:AddParagraph({ Title = " Nhiệm vụ song kiếm bị nguyền rủa ", Content = "Nhiệm Vụ :" });
spawn(function()
	while wait(.2) do
		if QuestYama_1 == true then
			I5:SetDesc(" Nhiệm vụ : yama quest 1");
		elseif QuestYama_2 == true then
			I5:SetDesc(" Nhiệm vụ : yama quest 2");
		elseif QuestYama_3 == true then
			I5:SetDesc(" Nhiệm vụ : yama quest 3");
		elseif QuestTushita_1 == true then
			I5:SetDesc(" Nhiệm vụ : tushita quest 1");
		elseif QuestTushita_2 == true then
			I5:SetDesc(" Nhiệm vụ : tushita quest 2");
		elseif QuestTushita_1 == true then
			I5:SetDesc(" Nhiệm vụ : tushita quest 2");
		elseif GetWP("Cursed Dual Katana") then
			I5:SetDesc(" Quest Numbers: CDK Hoàn Thành!!");
		end;
	end;
end);
Get:AddToggle({
...
Get:AddToggle({
 Name = "Auto nhiệm vụ Tushita CDK",
    Description = "",
    -- 1. Carrega o estado salvo ou false por padrão
...
if World2 then
Get:AddSection({"Tam Bảo Kiếm"});
Get:AddToggle({
 Name = "Auto Mua Kiếm Huyền Thoại",
    Description = "",
...
Get:AddToggle({
 Name = "Bay đến Người bán kiếm huyền thoại",
    Description = "",
    -- 1. Carrega o estado salvo ou false por padrão
    Default = GetSetting("TpLegendarySword_Save", false),
    Callback = function(I)
...
Get:AddSection({"Law boss"});

Get:AddToggle({
 Name = "Auto đánh boss law",
    Description = "",
    Default = false,
    Callback = function(state)
        _G.AutoLawKak = state
...
if World2 then
Get:AddSection({"Vật phẩm sea2"});
Get:AddToggle({
 Name = "Auto  kiếm Rengoku",
    Description = "",
    Default = false,
    Callback = function(I)
        _G.AutoKeyRen = I
...
Fruit:AddToggle({
	Name = "Mua chip với trái ít beli",
	Description = "",
	Default = false,
	Callback = function(state)
...
Fruit:AddSection({"Trái Blox Fruits"});
local J5 = {};
local function i5(I)
	local e = tostring(I);
	while true do
...
Fruit:AddButton({ Name = "Mua Trái stock thường", Description = "", Callback = function()
		replicated.Remotes.CommF_:InvokeServer("PurchaseRawFruit", _G.SelectFruit);
	end });
Fruit:AddDropdown({
	Name = "Chọn trái đảo kì bí",
	Description = "",
	Options = J5,
	Default = false,
	Multi = false,
...
Fruit:AddButton({ Name = "Mua kì bí stock", Description = "", Callback = function()
		replicated.Remotes.CommF_:InvokeServer("PurchaseRawFruit", SelectF_Adv);
	end });
Fruit:AddToggle({
	Name  = "Auto Random Trái",
    Description = "",
...
Setting:AddButton({ Name = "Chuyển sang phe hải tặc", Description = "", Callback = function()
		Pirates();
	end });
Setting:AddButton({ Name = "Chuyển sang phe hải quân", Description = "", Callback = function()
		Marines();
	end });
Setting:AddSection({"Khác"});
HakiSt = {
		"State 0",
		"State 1",
		"State 2",
...
Setting:AddButton({ Name = "Đổi cấp độ haki", Description = "", Callback = function()
...
Setting:AddButton({ Name = "Xoá sương mù", Description = "", Callback = function()
...
Setting:AddSection({"Fps - fix lag"});

Setting:AddButton({
    Name = "Kéo dài màn hình",
    Description = "",
    Callback = function()
        -- SETAR A RESOLUÇÃO
        getgenv().Resolution = {
...
Setting:AddButton({ Name = "Tăng fps", Description = "", Callback = function()
		LowCpu();
	end });
